...
namespace FitnessManager.BusinessLogic.FitnessClass
{
    public class FitnessClassService : IFitnessClassService
    {
        ...
        public FitnessClassService(IBaseRepository<FitnessClassEntity> fitnessClassRepository, IBaseRepository<InstructorEntity> instructorRepository,  IUnitOfWork unitOfWork, IMapper mapper)
        {
